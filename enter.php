...
if($_POST['submit']){
	...
	{
	    echo '<p align="center" style="color:#ffffff">###Доданий запис###</p>';
	    $file = "Sesion.txt";
...
?>
<p align="center"><a style="color:#ffffff" href="index.php">Головна</a> | <a style="color:#ffffff" href="contact.php">Контакти</a> | <a style="color:#ffffff" href="admin.php">Адмін</a></p>
<hr />
...
<div id="wrapper">
	<form id="signin" autocomplete="off"  method="post">
		<input type="text" id="user" name="user" placeholder="ім'я студента" required/>
		<input type="password" id="pass" name="pass" placeholder="пароль" required/>
		<button type="submit" name="submit" value="Войти">&#xf0da;</button>
	</form>
<div style="color:#ffffff"><?php
